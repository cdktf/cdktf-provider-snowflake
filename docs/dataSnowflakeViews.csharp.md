...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeViews.DataSnowflakeViewsConfig.property.withDescribe">WithDescribe</a></code> | <code>object</code> | Runs DESC VIEW for each view returned by SHOW VIEWS. |
