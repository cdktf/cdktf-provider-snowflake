...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12/externaltable"
...
| <code><a href="#@cdktf/provider-snowflake.externalTable.ExternalTableConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/1.0.3/docs/resources/external_table#id ExternalTable#id}. |
