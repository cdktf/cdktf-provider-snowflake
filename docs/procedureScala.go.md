...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12/procedurescala"
...
&procedurescala.ProcedureScalaConfig {
	...
	Secrets: interface{},
	TargetPath: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12.procedureScala.ProcedureScalaTargetPath,
	TraceLevel: *string,
}
```
...
| <code><a href="#@cdktf/provider-snowflake.procedureScala.ProcedureScalaConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/1.0.3/docs/resources/procedure_scala#id ProcedureScala#id}. |
