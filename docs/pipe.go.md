...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/pipe"
...
&pipe.PipeConfig {
	...
	Id: *string,
	Integration: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.pipe.PipeTimeouts,
}
```
