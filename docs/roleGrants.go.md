...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/rolegrants"
...
| <code><a href="#@cdktf/provider-snowflake.roleGrants.RoleGrantsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.83.1/docs/resources/role_grants#id RoleGrants#id}. |
