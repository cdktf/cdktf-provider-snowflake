...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12/datasnowflakemaskingpolicies"
...
&datasnowflakemaskingpolicies.DataSnowflakeMaskingPoliciesConfig {
	...
	Id: *string,
	In: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12.dataSnowflakeMaskingPolicies.DataSnowflakeMaskingPoliciesIn,
	Like: *string,
	Limit: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12.dataSnowflakeMaskingPolicies.DataSnowflakeMaskingPoliciesLimit,
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeMaskingPolicies.DataSnowflakeMaskingPoliciesConfig.property.withDescribe">WithDescribe</a></code> | <code>interface{}</code> | Runs DESC MASKING POLICY for each masking policy returned by SHOW MASKING POLICIES. |
