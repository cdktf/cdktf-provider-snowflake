...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/shareddatabase"
...
&shareddatabase.SharedDatabaseConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.sharedDatabase.SharedDatabaseTimeouts,
	TraceLevel: *string,
