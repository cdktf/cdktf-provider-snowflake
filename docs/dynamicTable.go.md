...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/dynamictable"
...
&dynamictable.DynamicTableConfig {
	...
	Query: *string,
	Schema: *string,
	TargetLag: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.dynamicTable.DynamicTableTargetLag,
	Warehouse: *string,
	Comment: *string,
	Id: *string,
	OrReplace: interface{},
