...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/scimintegration"
...
&scimintegration.ScimIntegrationConfig {
	...
	SyncPassword: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.scimIntegration.ScimIntegrationTimeouts,
}
```
