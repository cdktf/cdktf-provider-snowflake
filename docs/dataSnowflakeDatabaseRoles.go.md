...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/datasnowflakedatabaseroles"
...
&datasnowflakedatabaseroles.DataSnowflakeDatabaseRolesConfig {
	...
	Id: *string,
	Like: *string,
	Limit: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.dataSnowflakeDatabaseRoles.DataSnowflakeDatabaseRolesLimit,
}
```
