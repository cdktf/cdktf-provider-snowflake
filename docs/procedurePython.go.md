...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/procedurepython"
...
&procedurepython.ProcedurePythonConfig {
	...
	Secrets: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.procedurePython.ProcedurePythonTimeouts,
	TraceLevel: *string,
}
```
