...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/procedurepython"
...
&procedurepython.ProcedurePythonConfig {
	...
	Secrets: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.procedurePython.ProcedurePythonTimeouts,
	TraceLevel: *string,
}
```
