...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/schema"
...
&schema.SchemaConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.schema.SchemaTimeouts,
	TraceLevel: *string,
