...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/resourcemonitor"
...
&resourcemonitor.ResourceMonitorConfig {
	...
	SuspendTrigger: *f64,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.resourceMonitor.ResourceMonitorTimeouts,
}
```
