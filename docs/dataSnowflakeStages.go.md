...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v12/datasnowflakestages"
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeStages.DataSnowflakeStagesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/1.0.3/docs/data-sources/stages#id DataSnowflakeStages#id}. |
