...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9/externaltablegrant"
...
| <code><a href="#@cdktf/provider-snowflake.externalTableGrant.ExternalTableGrantConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.70.1/docs/resources/external_table_grant#id ExternalTableGrant#id}. |
