...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/failovergroup"
...
&failovergroup.FailoverGroupConfig {
	...
	FromReplica: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.failoverGroup.FailoverGroupFromReplica,
	Id: *string,
	IgnoreEditionCheck: interface{},
	ObjectTypes: *[]*string,
	ReplicationSchedule: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.failoverGroup.FailoverGroupReplicationSchedule,
}
```
...
&failovergroup.FailoverGroupReplicationSchedule {
	Cron: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.failoverGroup.FailoverGroupReplicationScheduleCron,
	Interval: *f64,
}
```
