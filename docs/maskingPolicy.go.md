...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7/maskingpolicy"
...
&maskingpolicy.MaskingPolicyConfig {
	...
	Schema: *string,
	Signature: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7.maskingPolicy.MaskingPolicySignature,
	Comment: *string,
