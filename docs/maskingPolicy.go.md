...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9/maskingpolicy"
...
&maskingpolicy.MaskingPolicyConfig {
	...
	Schema: *string,
	Signature: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9.maskingPolicy.MaskingPolicySignature,
	Comment: *string,
