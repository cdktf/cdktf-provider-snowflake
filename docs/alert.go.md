...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/alert"
...
&alert.AlertAlertSchedule {
	Cron: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.alert.AlertAlertScheduleCron,
	Interval: *f64,
}
```
...
&alert.AlertConfig {
	...
	Schema: *string,
	Warehouse: *string,
	AlertSchedule: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.alert.AlertAlertSchedule,
	Comment: *string,
	Enabled: interface{},
	Id: *string,
}
...
| <code><a href="#@cdktf/provider-snowflake.alert.AlertConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.68.2/docs/resources/alert#id Alert#id}. |
