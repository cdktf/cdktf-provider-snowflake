...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/alert"
...
Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs/resources/alert#import import section} in the documentation of this resource for the id to use
...
&alert.AlertAlertSchedule {
	Cron: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.alert.AlertAlertScheduleCron,
	Interval: *f64,
}
```
...
&alert.AlertConfig {
	...
	Schema: *string,
	Warehouse: *string,
	AlertSchedule: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.alert.AlertAlertSchedule,
	Comment: *string,
	Enabled: interface{},
	Id: *string,
}
...
| <code><a href="#@cdktf/provider-snowflake.alert.AlertConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs/resources/alert#id Alert#id}. |
