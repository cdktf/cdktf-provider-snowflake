...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/secretwithgenericstring"
...
&secretwithgenericstring.SecretWithGenericStringConfig {
	...
	Comment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.secretWithGenericString.SecretWithGenericStringTimeouts,
}
```
