...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/externalfunction"
...
&externalfunction.ExternalFunctionConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.externalFunction.ExternalFunctionTimeouts,
}
```
