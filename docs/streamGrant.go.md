...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v10/streamgrant"
...
streamgrant.StreamGrant_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
