...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/share"
...
&share.ShareConfig {
	...
	Comment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.share.ShareTimeouts,
}
```
