...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/userpublickeys"
...
&userpublickeys.UserPublicKeysConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.userPublicKeys.UserPublicKeysTimeouts,
}
```
