...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/userpublickeys"
...
&userpublickeys.UserPublicKeysConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.userPublicKeys.UserPublicKeysTimeouts,
}
```
