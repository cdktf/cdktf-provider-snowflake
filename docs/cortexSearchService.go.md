...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/cortexsearchservice"
...
&cortexsearchservice.CortexSearchServiceConfig {
	...
	Comment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.cortexSearchService.CortexSearchServiceTimeouts,
}
```
