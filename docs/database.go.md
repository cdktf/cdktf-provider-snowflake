...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9/database"
...
&database.DatabaseConfig {
	...
	ReplicationConfiguration: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9.database.DatabaseReplicationConfiguration,
}
```
