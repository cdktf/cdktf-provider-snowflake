...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/database"
...
&database.DatabaseConfig {
	...
	ReplicationConfiguration: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.database.DatabaseReplicationConfiguration,
}
```
