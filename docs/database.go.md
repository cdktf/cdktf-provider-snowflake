...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7/database"
...
&database.DatabaseConfig {
	...
	ReplicationConfiguration: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7.database.DatabaseReplicationConfiguration,
}
```
