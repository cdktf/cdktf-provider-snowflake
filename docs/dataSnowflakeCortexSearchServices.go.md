...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/datasnowflakecortexsearchservices"
...
&datasnowflakecortexsearchservices.DataSnowflakeCortexSearchServicesConfig {
	...
	Id: *string,
	In: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.dataSnowflakeCortexSearchServices.DataSnowflakeCortexSearchServicesIn,
	Like: *string,
	Limit: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.dataSnowflakeCortexSearchServices.DataSnowflakeCortexSearchServicesLimit,
	StartsWith: *string,
}
```
