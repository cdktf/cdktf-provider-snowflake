...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/accountparameter"
...
&accountparameter.AccountParameterConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.accountParameter.AccountParameterTimeouts,
}
```
