...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/accountparameter"
...
&accountparameter.AccountParameterConfig {
	...
	Value: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.accountParameter.AccountParameterTimeouts,
}
```
