...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/proceduregrant"
...
| <code><a href="#@cdktf/provider-snowflake.procedureGrant.ProcedureGrantConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.0/docs/resources/procedure_grant#id ProcedureGrant#id}. |
