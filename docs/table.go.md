...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7/table"
...
&table.TableColumn {
	...
	Type: *string,
	Comment: *string,
	Default: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7.table.TableColumnDefault,
	Identity: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7.table.TableColumnIdentity,
...
&table.TableConfig {
	...
	Id: *string,
	PrimaryKey: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7.table.TablePrimaryKey,
	Tag: interface{},
}
```
...
| <code><a href="#@cdktf/provider-snowflake.table.TableConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/resources/table#id Table#id}. |
