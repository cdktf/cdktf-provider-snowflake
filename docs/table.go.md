...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v10/table"
...
| <code><a href="#@cdktf/provider-snowflake.table.Table.property.dataRetentionDaysInput">DataRetentionDaysInput</a></code> | <code>*f64</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-snowflake.table.Table.property.dataRetentionDays">DataRetentionDays</a></code> | <code>*f64</code> | *No description.* |
...
&table.TableColumn {
	...
	Type: *string,
	Comment: *string,
	Default: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v10.table.TableColumnDefault,
	Identity: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v10.table.TableColumnIdentity,
...
&table.TableConfig {
	...
	Id: *string,
	PrimaryKey: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v10.table.TablePrimaryKey,
	Tag: interface{},
}
```
...
| <code><a href="#@cdktf/provider-snowflake.table.TableConfig.property.changeTracking">ChangeTracking</a></code> | <code>interface{}</code> | Specifies whether to enable change tracking on the table. Default false. |
...
| <code><a href="#@cdktf/provider-snowflake.table.TableConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.73.0/docs/resources/table#id Table#id}. |
