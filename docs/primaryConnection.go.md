...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/primaryconnection"
...
&primaryconnection.PrimaryConnectionConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.primaryConnection.PrimaryConnectionTimeouts,
}
```
