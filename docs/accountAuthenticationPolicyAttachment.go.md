...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/accountauthenticationpolicyattachment"
...
&accountauthenticationpolicyattachment.AccountAuthenticationPolicyAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.accountAuthenticationPolicyAttachment.AccountAuthenticationPolicyAttachmentTimeouts,
}
```
