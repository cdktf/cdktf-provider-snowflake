...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/stream"
...
| <code><a href="#@cdktf/provider-snowflake.stream.StreamConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.68.1/docs/resources/stream#id Stream#id}. |
