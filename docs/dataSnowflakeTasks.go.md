...
Refer to the Terraform Registory for docs: [`data_snowflake_tasks`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/data-sources/tasks).
...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/datasnowflaketasks"
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeTasks.DataSnowflakeTasksConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/data-sources/tasks#id DataSnowflakeTasks#id}. |
