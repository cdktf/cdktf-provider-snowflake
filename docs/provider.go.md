...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/provider"
...
&provider.SnowflakeProviderConfig {
	...
	Token: *string,
	TokenAccessor: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.provider.SnowflakeProviderTokenAccessor,
