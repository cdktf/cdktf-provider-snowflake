...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v7/resourcemonitorgrant"
...
| <code><a href="#@cdktf/provider-snowflake.resourceMonitorGrant.ResourceMonitorGrantConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/resources/resource_monitor_grant#id ResourceMonitorGrant#id}. |
