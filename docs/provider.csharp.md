...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProviderConfig.property.skipTomlFilePermissionVerification">SkipTomlFilePermissionVerification</a></code> | <code>object</code> | True by default. |
...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProviderConfig.property.useLegacyTomlFile">UseLegacyTomlFile</a></code> | <code>object</code> | True by default. |
...
```csharp
public object SkipTomlFilePermissionVerification { get; set; }
```
...
```csharp
public object UseLegacyTomlFile { get; set; }
```
