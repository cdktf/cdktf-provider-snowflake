...
```csharp
private void ResetOscpFailOpen()
```
...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProvider.property.oscpFailOpenInput">OscpFailOpenInput</a></code> | <code>object</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProvider.property.oscpFailOpen">OscpFailOpen</a></code> | <code>object</code> | *No description.* |
...
```csharp
public object OscpFailOpenInput { get; }
```
...
```csharp
public object OscpFailOpen { get; }
```
...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProviderConfig.property.oscpFailOpen">OscpFailOpen</a></code> | <code>object</code> | True represents OCSP fail open mode. |
...
| <code><a href="#@cdktf/provider-snowflake.provider.SnowflakeProviderConfig.property.validateDefaultParameters">ValidateDefaultParameters</a></code> | <code>object</code> | If true, disables the validation checks for Database, Schema, Warehouse and Role at the time a connection is established. |
...
```csharp
public object OscpFailOpen { get; set; }
```
