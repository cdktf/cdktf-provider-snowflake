...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/authenticationpolicy"
...
&authenticationpolicy.AuthenticationPolicyConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.authenticationPolicy.AuthenticationPolicyTimeouts,
}
```
