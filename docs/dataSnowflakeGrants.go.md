...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/datasnowflakegrants"
...
&datasnowflakegrants.DataSnowflakeGrantsConfig {
	...
	FutureGrantsIn: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsFutureGrantsIn,
	FutureGrantsTo: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsFutureGrantsTo,
	GrantsOf: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsGrantsOf,
	GrantsOn: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsGrantsOn,
	GrantsTo: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsGrantsTo,
	Id: *string,
}
```
...
&datasnowflakegrants.DataSnowflakeGrantsFutureGrantsIn {
	Database: *string,
	Schema: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8.dataSnowflakeGrants.DataSnowflakeGrantsFutureGrantsInSchema,
}
```
