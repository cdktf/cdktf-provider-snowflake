...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v8/account"
...
| <code><a href="#@cdktf/provider-snowflake.account.AccountConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.66.2/docs/resources/account#id Account#id}. |
