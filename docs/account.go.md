...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/account"
...
&account.AccountConfig {
	...
	Region: *string,
	RegionGroup: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.account.AccountTimeouts,
}
```
