...
&apiauthenticationintegrationwithjwtbearer.ApiAuthenticationIntegrationWithJwtBearerConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake.apiAuthenticationIntegrationWithJwtBearer.ApiAuthenticationIntegrationWithJwtBearerTimeouts,
}
```
