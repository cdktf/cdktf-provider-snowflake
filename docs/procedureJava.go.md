...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/procedurejava"
...
&procedurejava.ProcedureJavaConfig {
	...
	Secrets: interface{},
	TargetPath: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.procedureJava.ProcedureJavaTargetPath,
	TraceLevel: *string,
}
```
...
| <code><a href="#@cdktf/provider-snowflake.procedureJava.ProcedureJavaConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs/resources/procedure_java#id ProcedureJava#id}. |
