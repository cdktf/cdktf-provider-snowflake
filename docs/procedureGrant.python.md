...
| <code><a href="#@cdktf/provider-snowflake.procedureGrant.ProcedureGrant.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/procedure_grant#id ProcedureGrant#id}. |
...
| <code><a href="#@cdktf/provider-snowflake.procedureGrant.ProcedureGrant.toHclTerraform">to_hcl_terraform</a></code> | *No description.* |
...
##### `to_hcl_terraform` <a name="to_hcl_terraform" id="@cdktf/provider-snowflake.procedureGrant.ProcedureGrant.toHclTerraform"></a>
...
| <code><a href="#@cdktf/provider-snowflake.procedureGrant.ProcedureGrantConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.1/docs/resources/procedure_grant#id ProcedureGrant#id}. |
