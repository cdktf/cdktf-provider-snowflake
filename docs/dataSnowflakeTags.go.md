...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/datasnowflaketags"
...
&datasnowflaketags.DataSnowflakeTagsConfig {
	...
	Id: *string,
	In: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.dataSnowflakeTags.DataSnowflakeTagsIn,
	Like: *string,
}
```
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeTags.DataSnowflakeTagsConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.99.0/docs/data-sources/tags#id DataSnowflakeTags#id}. |
