...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/functionsql"
...
&functionsql.FunctionSqlConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake.functionSql.FunctionSqlTimeouts,
	TraceLevel: *string,
}
```
