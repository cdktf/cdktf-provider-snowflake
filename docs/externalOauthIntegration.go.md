...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/externaloauthintegration"
...
&externaloauthintegration.ExternalOauthIntegrationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.externalOauthIntegration.ExternalOauthIntegrationTimeouts,
}
```
