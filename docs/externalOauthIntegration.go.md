...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/externaloauthintegration"
...
&externaloauthintegration.ExternalOauthIntegrationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.externalOauthIntegration.ExternalOauthIntegrationTimeouts,
}
```
