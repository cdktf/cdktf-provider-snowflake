...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15/streamlit"
...
```go
func PutTimeouts(value StreamlitTimeouts)
```
...
| <code><a href="#@cdktf/provider-snowflake.streamlit.Streamlit.property.timeoutsInput">TimeoutsInput</a></code> | <code>interface{}</code> | *No description.* |
...
```go
func Timeouts() StreamlitTimeoutsOutputReference
```
...
&streamlit.StreamlitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15.streamlit.StreamlitTimeouts,
	Title: *string,
}
```
...
streamlit.NewStreamlitTimeoutsOutputReference(terraformResource IInterpolatingParent, terraformAttribute *string) StreamlitTimeoutsOutputReference
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktf/provider-snowflake.streamlit.StreamlitTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>github.com/hashicorp/terraform-cdk-go/cdktf.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktf/provider-snowflake.streamlit.StreamlitTimeoutsOutputReference.property.internalValue">InternalValue</a></code> | <code>interface{}</code> | *No description.* |
