...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/streamlit"
...
&streamlit.StreamlitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.streamlit.StreamlitTimeouts,
	Title: *string,
}
```
