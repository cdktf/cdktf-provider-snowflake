...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/streamlit"
...
&streamlit.StreamlitConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.streamlit.StreamlitTimeouts,
	Title: *string,
}
```
