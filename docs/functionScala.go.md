...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/functionscala"
...
&functionscala.FunctionScalaConfig {
	...
	Secrets: interface{},
	TargetPath: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.functionScala.FunctionScalaTargetPath,
	TraceLevel: *string,
}
```
