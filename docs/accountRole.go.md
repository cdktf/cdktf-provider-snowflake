...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/accountrole"
...
&accountrole.AccountRoleConfig {
	...
	Comment: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.accountRole.AccountRoleTimeouts,
}
```
