...
externalOauthIntegration.ExternalOauthIntegration(
  ...
  scope_mapping_attribute: str = None
)
```
...
| <code><a href="#@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.Initializer.parameter.scopeMappingAttribute">scope_mapping_attribute</a></code> | <code>str</code> | Specifies the access token claim to map the access token to an account role. |
...
##### `scope_mapping_attribute`<sup>Optional</sup> <a name="scope_mapping_attribute" id="@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.Initializer.parameter.scopeMappingAttribute"></a>
...
| <code><a href="#@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.resetScopeMappingAttribute">reset_scope_mapping_attribute</a></code> | *No description.* |
...
##### `reset_scope_mapping_attribute` <a name="reset_scope_mapping_attribute" id="@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.resetScopeMappingAttribute"></a>

```python
def reset_scope_mapping_attribute() -> None
```
...
Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.1/docs/resources/external_oauth_integration#import import section} in the documentation of this resource for the id to use
...
| <code><a href="#@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.property.scopeMappingAttributeInput">scope_mapping_attribute_input</a></code> | <code>str</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.property.scopeMappingAttribute">scope_mapping_attribute</a></code> | <code>str</code> | *No description.* |
...
##### `scope_mapping_attribute_input`<sup>Optional</sup> <a name="scope_mapping_attribute_input" id="@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.property.scopeMappingAttributeInput"></a>

```python
scope_mapping_attribute_input: str
```
...
##### `scope_mapping_attribute`<sup>Required</sup> <a name="scope_mapping_attribute" id="@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegration.property.scopeMappingAttribute"></a>
...
| <code><a href="#@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegrationConfig.property.scopeMappingAttribute">scope_mapping_attribute</a></code> | <code>str</code> | Specifies the access token claim to map the access token to an account role. |
...
##### `scope_mapping_attribute`<sup>Optional</sup> <a name="scope_mapping_attribute" id="@cdktf/provider-snowflake.externalOauthIntegration.ExternalOauthIntegrationConfig.property.scopeMappingAttribute"></a>
