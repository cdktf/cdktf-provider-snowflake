...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/notificationintegration"
...
&notificationintegration.NotificationIntegrationConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.notificationIntegration.NotificationIntegrationTimeouts,
	Type: *string,
}
```
