...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/tag"
...
&tag.TagConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.tag.TagTimeouts,
}
```
