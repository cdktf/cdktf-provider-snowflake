...
Refer to the Terraform Registory for docs: [`data_snowflake_roles`](https://registry.terraform.io/providers/snowflake-labs/snowflake/0.70.1/docs/data-sources/roles).
...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v9/datasnowflakeroles"
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeRoles.DataSnowflakeRolesConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.70.1/docs/data-sources/roles#id DataSnowflakeRoles#id}. |
