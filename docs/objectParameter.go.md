...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14/objectparameter"
...
&objectparameter.ObjectParameterConfig {
	...
	ObjectType: *string,
	OnAccount: interface{},
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v14.objectParameter.ObjectParameterTimeouts,
}
```
