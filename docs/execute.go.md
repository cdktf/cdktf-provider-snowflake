...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15/execute"
...
&execute.ExecuteConfig {
	...
	Id: *string,
	Query: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15.execute.ExecuteTimeouts,
}
```
