...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13/execute"
...
&execute.ExecuteConfig {
	...
	Id: *string,
	Query: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v13.execute.ExecuteTimeouts,
}
```
