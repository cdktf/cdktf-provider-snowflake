...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11/datasnowflakeschemas"
...
&datasnowflakeschemas.DataSnowflakeSchemasConfig {
	...
	Id: *string,
	In: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.dataSnowflakeSchemas.DataSnowflakeSchemasIn,
	Like: *string,
	Limit: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v11.dataSnowflakeSchemas.DataSnowflakeSchemasLimit,
	StartsWith: *string,
...
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeSchemas.DataSnowflakeSchemasConfig.property.withDescribe">WithDescribe</a></code> | <code>interface{}</code> | Runs DESC SCHEMA for each schema returned by SHOW SCHEMAS. |
| <code><a href="#@cdktf/provider-snowflake.dataSnowflakeSchemas.DataSnowflakeSchemasConfig.property.withParameters">WithParameters</a></code> | <code>interface{}</code> | Runs SHOW PARAMETERS FOR SCHEMA for each schema returned by SHOW SCHEMAS. |
