...
```go
import "github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15/grantprivilegestoshare"
...
&grantprivilegestoshare.GrantPrivilegesToShareConfig {
	...
	OnTag: *string,
	OnView: *string,
	Timeouts: github.com/cdktf/cdktf-provider-snowflake-go/snowflake/v15.grantPrivilegesToShare.GrantPrivilegesToShareTimeouts,
}
```
