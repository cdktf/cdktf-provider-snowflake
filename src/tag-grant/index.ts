// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.75.0/docs/resources/tag_grant
...
export class TagGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing TagGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.75.0/docs/resources/tag_grant#import import section} in the documentation of this resource for the id to use
