...
// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.0/docs
...
export class SnowflakeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.84.0/docs snowflake} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  public set ocspFailOpen(value: boolean | cdktf.IResolvable | undefined) {
