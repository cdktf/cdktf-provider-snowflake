...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs
...
export class SnowflakeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.9.0/docs#import import section} in the documentation of this resource for the id to use
