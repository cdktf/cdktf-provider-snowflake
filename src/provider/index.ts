...
export class SnowflakeProvider extends cdktf.TerraformProvider {
  ...
  */
  public constructor(scope: Construct, id: string, config: SnowflakeProviderConfig = {}) {
    ...
    this._logQueryParameters = config.logQueryParameters;
  ...
  public resetLogQueryParameters() {
    this._logQueryParameters = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get logQueryParametersInput() {
    return this._logQueryParameters;
  }
  ...
  public resetLogQueryText() {
    this._logQueryText = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get logQueryTextInput() {
    return this._logQueryText;
  }
