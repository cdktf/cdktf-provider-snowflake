...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.1/docs
...
export class SnowflakeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.1/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: SnowflakeProviderConfig = {}) {
    ...
    this._experimentalFeaturesEnabled = config.experimentalFeaturesEnabled;
    ...
    this._oauthScope = config.oauthScope;
    this._oauthTokenRequestUrl = config.oauthTokenRequestUrl;
    ...
    this._workloadIdentityEntraResource = config.workloadIdentityEntraResource;
  ...
  public resetEnableSingleUseRefreshTokens() {
    this._enableSingleUseRefreshTokens = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableSingleUseRefreshTokensInput() {
    return this._enableSingleUseRefreshTokens;
  }

  // experimental_features_enabled - computed: false, optional: true, required: false
  private _experimentalFeaturesEnabled?: string[]; 
  public get experimentalFeaturesEnabled() {
    return this._experimentalFeaturesEnabled;
  }
  public set experimentalFeaturesEnabled(value: string[] | undefined) {
    this._experimentalFeaturesEnabled = value;
  }
  public resetExperimentalFeaturesEnabled() {
    this._experimentalFeaturesEnabled = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get experimentalFeaturesEnabledInput() {
    return this._experimentalFeaturesEnabled;
  }
  ...
  public set oauthAuthorizationUrl(value: string | undefined) {
    this._oauthAuthorizationUrl = value;
  }
  public resetOauthAuthorizationUrl() {
  ...
  public set oauthRedirectUri(value: string | undefined) {
  ...
  public set oauthScope(value: string | undefined) {
  ...
  // oauth_token_request_url - computed: false, optional: true, required: false
  private _oauthTokenRequestUrl?: string; 
  public get oauthTokenRequestUrl() {
    return this._oauthTokenRequestUrl;
  }
  public set oauthTokenRequestUrl(value: string | undefined) {
    this._oauthTokenRequestUrl = value;
  }
  public resetOauthTokenRequestUrl() {
    this._oauthTokenRequestUrl = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get oauthTokenRequestUrlInput() {
    return this._oauthTokenRequestUrl;
  }
  ...
  // workload_identity_entra_resource - computed: false, optional: true, required: false
  private _workloadIdentityEntraResource?: string; 
  public get workloadIdentityEntraResource() {
    return this._workloadIdentityEntraResource;
  }
  public set workloadIdentityEntraResource(value: string | undefined) {
    this._workloadIdentityEntraResource = value;
  }
  public resetWorkloadIdentityEntraResource() {
    this._workloadIdentityEntraResource = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get workloadIdentityEntraResourceInput() {
    return this._workloadIdentityEntraResource;
  }

  // workload_identity_provider - computed: false, optional: true, required: false
  private _workloadIdentityProvider?: string; 
  public get workloadIdentityProvider() {
    return this._workloadIdentityProvider;
  }
  public set workloadIdentityProvider(value: string | undefined) {
    this._workloadIdentityProvider = value;
  }
  public resetWorkloadIdentityProvider() {
    this._workloadIdentityProvider = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get workloadIdentityProviderInput() {
    return this._workloadIdentityProvider;
  }
