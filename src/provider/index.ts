// https://registry.terraform.io/providers/snowflakedb/snowflake/1.2.1/docs
...
export interface SnowflakeProviderConfig {
  ...
  */
  ...
  /**
  * True by default. When this is set to true, the provider expects the legacy TOML format. Otherwise, it expects the new format. See more in [the section below](#order-precedence) Can also be sourced from the `SNOWFLAKE_USE_LEGACY_TOML_FILE` environment variable.
  *
...
export class SnowflakeProvider extends cdktf.TerraformProvider {
  ...
  * @param importFromId The id of the existing SnowflakeProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/1.2.1/docs#import import section} in the documentation of this resource for the id to use
