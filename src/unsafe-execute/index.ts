...
// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/unsafe_execute
...
export class UnsafeExecute extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing UnsafeExecute that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/unsafe_execute#import import section} in the documentation of this resource for the id to use
