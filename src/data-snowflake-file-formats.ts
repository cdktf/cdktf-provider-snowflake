...
export class DataSnowflakeFileFormatsFileFormatsOutputReference extends cdktf.ComplexObject {
...
export class DataSnowflakeFileFormatsFileFormatsList extends cdktf.ComplexList {
