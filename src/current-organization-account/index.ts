...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.1/docs/resources/current_organization_account
...
export interface CurrentOrganizationAccountConfig extends cdktf.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: CurrentOrganizationAccountTimeouts;
}
export interface CurrentOrganizationAccountShowOutput {
}

export function currentOrganizationAccountShowOutputToTerraform(struct?: CurrentOrganizationAccountShowOutput): any {
...
export function currentOrganizationAccountShowOutputToHclTerraform(struct?: CurrentOrganizationAccountShowOutput): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CurrentOrganizationAccountShowOutputOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): CurrentOrganizationAccountShowOutput | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: CurrentOrganizationAccountShowOutput | undefined) {
    if (value === undefined) {
...
export class CurrentOrganizationAccountShowOutputList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): CurrentOrganizationAccountShowOutputOutputReference {
    return new CurrentOrganizationAccountShowOutputOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface CurrentOrganizationAccountTimeouts {
  /**
...
export function currentOrganizationAccountTimeoutsToTerraform(struct?: CurrentOrganizationAccountTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function currentOrganizationAccountTimeoutsToHclTerraform(struct?: CurrentOrganizationAccountTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class CurrentOrganizationAccountTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): CurrentOrganizationAccountTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: CurrentOrganizationAccountTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class CurrentOrganizationAccount extends cdktf.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowflake_current_organization_account";
  ...
  * @param importToId The construct id used in the generated config for the CurrentOrganizationAccount to import
  * @param importFromId The id of the existing CurrentOrganizationAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.10.1/docs/resources/current_organization_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_current_organization_account", importId: importFromId, provider });
      }
  ...
  * @param options CurrentOrganizationAccountConfig
  */
  public constructor(scope: Construct, id: string, config: CurrentOrganizationAccountConfig) {
    super(scope, id, {
  ...
  private _showOutput = new CurrentOrganizationAccountShowOutputList(this, "show_output", false);
  ...
  private _timeouts = new CurrentOrganizationAccountTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: CurrentOrganizationAccountTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: currentOrganizationAccountTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: currentOrganizationAccountTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "CurrentOrganizationAccountTimeouts",
      },
    };
