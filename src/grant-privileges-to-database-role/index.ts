// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.83.1/docs/resources/grant_privileges_to_database_role
...
export interface GrantPrivilegesToDatabaseRoleConfig extends cdktf.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * This field should not be set and its main purpose is to achieve the functionality described by always_apply field. This is value will be flipped to the opposite value on every terraform apply, thus creating a new plan that will re-apply grants.
  *
