...
// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.65.0/docs/resources/role_grants
...
export interface RoleGrantsConfig extends cdktf.TerraformMetaArguments {
  /**
  * When this is set to false, multiple grants of the same type cannot be created. This will cause Terraform to revoke grants applied to roles and objects outside Terraform.
  * 
