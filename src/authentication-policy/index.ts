...
// https://registry.terraform.io/providers/snowflakedb/snowflake/2.4.0/docs/resources/authentication_policy
...
export class AuthenticationPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing AuthenticationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.4.0/docs/resources/authentication_policy#import import section} in the documentation of this resource for the id to use
