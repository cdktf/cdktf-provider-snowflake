// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs/resources/row_access_policy
...
export class RowAccessPolicy extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing RowAccessPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.94.1/docs/resources/row_access_policy#import import section} in the documentation of this resource for the id to use
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      row_access_expression: {
        value: cdktf.stringToHclTerraform(this._rowAccessExpression),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      signature: {
        value: cdktf.hashMapperHcl(cdktf.stringToHclTerraform)(this._signature),
        isBlock: false,
        type: "map",
