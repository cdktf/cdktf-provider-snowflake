// https://www.terraform.io/docs/providers/snowflake/d/functions
...
export class DataSnowflakeFunctionsFunctions extends cdktf.ComplexComputedList {
...
export class DataSnowflakeFunctions extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "snowflake_functions";
  ...
  */
  ...
  public functions(index: string) {
    return new DataSnowflakeFunctionsFunctions(this, 'functions', index, false);
  }
