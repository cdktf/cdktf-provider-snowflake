// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/failover_group_grant
...
export class FailoverGroupGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing FailoverGroupGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.77.0/docs/resources/failover_group_grant#import import section} in the documentation of this resource for the id to use
