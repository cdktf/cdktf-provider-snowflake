// https://www.terraform.io/docs/providers/snowflake/r/row_access_policy_grant
...
export class RowAccessPolicyGrant extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "snowflake_row_access_policy_grant";
