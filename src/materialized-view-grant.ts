// https://www.terraform.io/docs/providers/snowflake/r/materialized_view_grant
...
export class MaterializedViewGrant extends cdktf.TerraformResource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType: string = "snowflake_materialized_view_grant";
