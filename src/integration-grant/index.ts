...
// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.74.0/docs/resources/integration_grant
...
export class IntegrationGrant extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationGrant that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.74.0/docs/resources/integration_grant#import import section} in the documentation of this resource for the id to use
