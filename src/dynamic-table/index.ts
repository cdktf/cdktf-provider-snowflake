// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table
...
export interface DynamicTableConfig extends cdktf.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#comment DynamicTable#comment}
  */
  readonly comment?: string;
  /**
  * The database in which to create the dynamic table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#database DynamicTable#database}
  */
  readonly database: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#id DynamicTable#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#initialize DynamicTable#initialize}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#name DynamicTable#name}
  */
  readonly name: string;
  /**
  * Specifies whether to replace the dynamic table if it already exists.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#or_replace DynamicTable#or_replace}
  */
  readonly orReplace?: boolean | cdktf.IResolvable;
  /**
  * Specifies the query to use to populate the dynamic table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#query DynamicTable#query}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#refresh_mode DynamicTable#refresh_mode}
  */
  readonly refreshMode?: string;
  /**
  * The schema in which to create the dynamic table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#schema DynamicTable#schema}
  */
  readonly schema: string;
  /**
  * The warehouse in which to create the dynamic table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#warehouse DynamicTable#warehouse}
  */
  readonly warehouse: string;
  /**
  * target_lag block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#target_lag DynamicTable#target_lag}
  */
...
export interface DynamicTableTargetLag {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#downstream DynamicTable#downstream}
  */
  readonly downstream?: boolean | cdktf.IResolvable;
  /**
  * Specifies the maximum target lag time for the dynamic table.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#maximum_duration DynamicTable#maximum_duration}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table snowflake_dynamic_table}
*/
export class DynamicTable extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DynamicTable that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.87.2/docs/resources/dynamic_table snowflake_dynamic_table} Resource
  *
  * @param scope The scope in which to define this construct
