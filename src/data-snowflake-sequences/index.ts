// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs/data-sources/sequences
...
export interface DataSnowflakeSequencesSequences {
}

export function dataSnowflakeSequencesSequencesToTerraform(struct?: DataSnowflakeSequencesSequences): any {
...
export function dataSnowflakeSequencesSequencesToHclTerraform(struct?: DataSnowflakeSequencesSequences): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSnowflakeSequencesSequencesOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataSnowflakeSequencesSequences | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataSnowflakeSequencesSequences | undefined) {
    if (value === undefined) {
...
export class DataSnowflakeSequencesSequencesList extends cdktf.ComplexList {
  ...
  */
  public get(index: number): DataSnowflakeSequencesSequencesOutputReference {
    return new DataSnowflakeSequencesSequencesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataSnowflakeSequences extends cdktf.TerraformDataSource {
  ...
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "snowflake_sequences";
  ...
  * @param importFromId The id of the existing DataSnowflakeSequences that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.100.0/docs/data-sources/sequences#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "snowflake_sequences", importId: importFromId, provider });
      }
  ...
  */
  ...
  private _sequences = new DataSnowflakeSequencesSequencesList(this, "sequences", false);
