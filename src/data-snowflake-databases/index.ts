// https://registry.terraform.io/providers/snowflake-labs/snowflake/0.90.0/docs/data-sources/databases
...
export function dataSnowflakeDatabasesDatabasesReplicationConfigurationToHclTerraform(struct?: DataSnowflakeDatabasesDatabasesReplicationConfiguration): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataSnowflakeDatabases extends cdktf.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataSnowflakeDatabases that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflake-labs/snowflake/0.90.0/docs/data-sources/databases#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      terse: {
        value: cdktf.booleanToHclTerraform(this._terse),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
