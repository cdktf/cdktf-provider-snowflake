// https://registry.terraform.io/providers/snowflakedb/snowflake/2.1.0/docs/resources/secret_with_generic_string
...
export class SecretWithGenericString extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing SecretWithGenericString that should be imported. Refer to the {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.1.0/docs/resources/secret_with_generic_string#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/snowflakedb/snowflake/2.1.0/docs/resources/secret_with_generic_string snowflake_secret_with_generic_string} Resource
  *
  * @param scope The scope in which to define this construct
