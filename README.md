...
# CDKTF prebuilt bindings for snowflakedb/snowflake provider version 1.0.5

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/1.0.5/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/1.0.5)
