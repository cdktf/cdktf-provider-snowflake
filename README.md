...
# CDKTF prebuilt bindings for snowflakedb/snowflake provider version 2.11.0

This repo builds and publishes the [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.11.0/docs) bindings for [CDK for Terraform](https://cdk.tf).
...
- [Terraform snowflake provider](https://registry.terraform.io/providers/snowflakedb/snowflake/2.11.0)
